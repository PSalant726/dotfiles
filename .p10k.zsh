# Generated by Powerlevel10k configuration wizard on 2022-09-11 at 11:51 MDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local conflicted='%093F'  # purple foreground
    else
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=129
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|px'
